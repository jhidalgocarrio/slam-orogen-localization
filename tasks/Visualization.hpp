...
#ifndef ROVER_LOCALIZATION_VISUALIZATION_TASK_HPP
#define ROVER_LOCALIZATION_VISUALIZATION_TASK_HPP
...
namespace rover_localization {
     ...
     * position and orientation of foot 4 Contact point frame of Rear Right Wheel wrt the Body center
     * \details
     * The name of a TaskContext is primarily defined via:
     \verbatim
     deployment 'deployment_name'
         task('custom_task_name','rover_localization::Visualization')
     end
     \endverbatim
