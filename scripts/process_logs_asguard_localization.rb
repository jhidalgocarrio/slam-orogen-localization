...
framework = {:proprio => false, :vicon => false, :proprio_vicon => false, :proprio_vicon_head => true, :viz => true}
...
Orocos.run 'rover_localization::FrontEnd' => 'frontend',  'rover_localization::BackEnd' => 'backend', 'rover_localization::Visualization' => 'visualization' do
    ...
    Orocos.conf.apply(frontend, ['default', 'asguard', 'bremen', 'stim300'], :override => true )
