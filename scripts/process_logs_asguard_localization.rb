...
viz = {:ikf_attitude => false, :proprio => false}
...
Orocos.run('asguard_localization_test') do 
    ...
    if viz[:ikf_attitude]
	log_replay.ikf_orientation_estimator.attitude_b_g.connect_to(asguard_localization_task.orientation_init, :type => :buffer, :size => 100 )
    else
# 	log_replay.xsens_imu.orientation_samples.connect_to(asguard_localization_task.orientation_init, :type => :buffer, :size => 10 )
    end

    asguard_localization_task.calibrated_sensors.frame = "stim300"
    asguard_localization_task.orientation_init.frame = "stim300"
...
#     
#     asguard_localization_task.body2world_out.connect_to BC
#     asguard_localization_task.body2world_out.connect_to do |asguard_rbs,_|
# 	asguardViz.updateRigidBodyState(asguard_rbs)
#     end
#     
#     
#     asguard_localization_task.body2world_out.connect_to do |data,_|
